...
const EndTime = () => {
  ...
  return (
    <div className="flex justify-start items-center">
      <div className="flex flex-col gap-1 font-bold text-black">
        <p>{t("timer.days")}</p>
        <div>
          <span className="text-[20px] sm:text-[40px] py-1 px-2">
          ...
          <span
            className={
              countDownTime?.days?.length <= 2
                ? "hidden"
                : "text-[20px] text-black sm:text-[40px] py-1 px-2"
            }
          >
      ...
      <span className="text-[#E07575] text-[20px] sm:text-[40px] mt-5">:</span>
